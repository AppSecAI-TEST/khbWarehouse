...
public interface ActivityActionFacade{
	/**
	 * 新增事件
	 * @author cdt
	 * @date 2016-5-16
	 ...
	 * @time 下午3:33:30
	 */
	public void updateActivityAction(ActivityActionDTO actionDto,String prizes,String odds,String versions,String levels);
