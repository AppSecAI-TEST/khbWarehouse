...
public class ActivityInvForProInfoDTO implements Serializable{
    /**
	 * 
	 */
	private static final long serialVersionUID = -7972835630398417681L;
	...
	public String toString() {
		return "ActivityInvForProInfoDTO [id=" + id + ", name=" + name
