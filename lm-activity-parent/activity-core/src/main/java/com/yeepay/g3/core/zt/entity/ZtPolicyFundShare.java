...
/**
 * @Description 会员策略交易记录中基金交易持有汇总实体类
 * 记录策略交易的基金交易汇总
 * @version 1.0
 */
public class ZtPolicyFundShare implements EntityVersion<Long>{
    /**
	 * 
	 */
	private static final long serialVersionUID = 3073996274061296624L;
