 ...
 * @version 1.0
 */
public class ActivityRule implements EntityVersion<Long> {
	...
	public String toString() {
		return "ActivityRule [id=" + id + ", version=" + version
				+ ", ruleCode=" + ruleCode + ", ruleName=" + ruleName
				+ ", takeEffectTime=" + takeEffectTime + ", invalidTime="
				+ invalidTime + ", ruleStatus=" + ruleStatus + ", createTime="
				+ createTime + ", creator=" + creator + ", checkedTime="
				+ checkedTime + ", checkor=" + checkor + "]";
	}
}