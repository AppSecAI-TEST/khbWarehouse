...
/**
 * @Description 送流量活动选择流量通道数据实体
 * @author ping.zhu
 * @CreateTime 2016年7月20日 下午15:30:29
 * @version 1.0
 */
public class ActivitySrcFlowPlat implements EntityVersion<Long>{
	...
	public String toString() {
		return "ActivitySrcFlowPlat [id=" + id + ", version=" + version
