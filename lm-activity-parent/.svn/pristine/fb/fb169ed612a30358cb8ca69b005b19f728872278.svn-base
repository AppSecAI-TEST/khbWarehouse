...
public class ActivityPrizeFacadeImpl implements ActivityPrizeFacade {
	...
	/* (non-Javadoc)
	 * @see com.yeepay.g3.facade.activity.facade.ActivityPrizeFacade#queryByActionCode(java.lang.String)
	 */
	@Override
	public List<ActivityPrizeDTO> queryByActionCode(String actionCode) {
		List<ActivityPrize> activityPrizeList = activityPrizeServiceImpl.queryByActionCode(actionCode);
		List<ActivityPrizeDTO> activityPrizeDtoList = EntityDTOConvert.toTragetList(activityPrizeList, ActivityPrizeDTO.class);
		return activityPrizeDtoList;
	}
