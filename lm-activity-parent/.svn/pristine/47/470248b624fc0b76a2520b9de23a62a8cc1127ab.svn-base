...
public class ActivityCoupon implements EntityVersion<Long> {
	...
	public String toString() {
		return "ActivityCoupon [id=" + id + ", version=" + version
				+ ", couponName=" + couponName + ", couponType=" + couponType
				+ ", discountType=" + discountType + ", minInvestAmount="
				+ minInvestAmount + ", couponAmount=" + couponAmount
				+ ", increaseInterest=" + increaseInterest + ", ruleDesc="
				+ ruleDesc + ", totalCount=" + totalCount + ", grantCount="
				+ grantCount + ", validityType=" + validityType
				+ ", validityDays=" + validityDays + ", validityDate="
				+ validityDate + ", couponStatus=" + couponStatus
				+ ", createTime=" + createTime + ", creator=" + creator
				+ ", checkedTime=" + checkedTime + ", checkor=" + checkor
				+ ", couponRemark=" + couponRemark + ", isRedPacket="
				+ isRedPacket + "]";
	}
}