...
/**
 * @Description 会员策略交易记录中基金交易订单明细实体类
 * 记录每次组合交易的基金交易明细
 * @version 1.0
 */
public class ZtPolicyFundOrderDetail implements EntityVersion<Long>{
    /**
	 * 
	 */
	private static final long serialVersionUID = -4448472741456928850L;
