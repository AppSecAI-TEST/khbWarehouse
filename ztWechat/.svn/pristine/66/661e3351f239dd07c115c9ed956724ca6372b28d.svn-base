...
<script type="text/javascript" src="static/js/assets/totalWealthScroll.js?v=<%=sysVersion %>"></script> --%>
    ...
    <div class="myassetCard font-white pr">
        ...
        <div class="panel pa" style="display: none">
            <span class="profitTip tc pr">
                ...
                总财富=懒猫账户余额+基金理财金额+定期理财金额+活期理财金额+我的灵机一投金额
            </span>
        </div>
    </div>
   <div class="listArea bg-white">
        <ul>
            <li onclick="window.location.href='zt/asset/toMyPolicyInvest'">
                    <i class="icon icon-arrow-right fr"></i>   
                   灵机一投金额：<e:property value="@_formater.formatNumber(policyAmount)" />元
            </li>
            <li onclick="window.location.href='${fundSalesUrl}myfund/fastFund?memberNo=${ascMemberNo }&platform=<e:property value='@platform'/>'">
                <i class="icon icon-arrow-right fr"></i>   
                基金理财金额：<e:property value="@_formater.formatNumber(fundTotalAmount)" />元
            </li>
            <li onclick="window.location.href='fixed/toBill'">
                <i class="icon icon-arrow-right fr"></i>
                定期理财金额：<e:property value="@_formater.formatNumber(xtTotalAmount)" />元
            </li>
            <li onclick="window.location.href='scb/toScb'">
                <i class="icon icon-arrow-right fr"></i>
                活期理财金额：<e:property value="@_formater.formatNumber(balanceInfoResult)" />元
            </li>
            <li onclick="window.location.href='asset/toMyAcount'">
                <i class="icon icon-arrow-right fr"></i>
                                                       懒猫账户余额：<e:property value="@_formater.formatNumber(accountBalanceResult)" />元
            </li>
            <li onclick="window.location.href='asset/toCashOnTheWay'">
                <i class="icon icon-arrow-right fr"></i>
                    提现在途金额：<e:property value="@_formater.formatNumber(freezeAmount)" />元
            </li>
        </ul>
    </div>
