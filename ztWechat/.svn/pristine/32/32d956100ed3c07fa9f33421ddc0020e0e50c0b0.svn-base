...
<div style="background: #fdeaca">
    <div class="pr">
        <img src="static/images/activity/lmjf-01.jpg" class="repeatImg"/>
        <img src="static/images/activity/lmjf-02.jpg" class="repeatImg"/>
        <img src="static/images/activity/lmjf-03.jpg" class="repeatImg"/>
    </div>
...
<div class="h0-5"></div>
    <div class="pr">
        <img src="static/images/activity/lmjf-04.jpg" class="repeatImg"/>
        <img src="static/images/activity/lmjf-05.jpg" class="repeatImg"/>
    </div>
    <div class="ruleTab">
        <ul class="tab_nav">
        ...
        <div class="tab_con">
            <blockquote style="display: block">
                <div class="activityRule">
                    <h2 class="activityDate">活动时间：即日起至2016年7月31日</h2>
                    <ul>
                        <li>1、赠送流量总计1000000M，先到先得，送完为止，每个用户限领取一次；</li>
                        <li>2、仅限活动期间注册并完成绑卡，或首次投资的用户领取流量(限购买定期理财产品新手标除外)；</li>
                        <li>3、投资金额指单笔投资，不含累计；</li>
                        <li>4、参与范围：全国移动、电信、联通用户（欠费、时长用户除外）；</li>
                        <li>5、流量属性：全国通用流量（当月有效，两个工作日到账，月末三天内所获流量将于下月初到账）；</li>
                        <li>6、微信关注懒猫金服(微信号lanmaojf)即可登录账户查看优惠券、购买记录等信息；</li>
