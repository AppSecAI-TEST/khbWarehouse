    ...
    <div class="tab_con pb15">
      <blockquote id="totalIncome" style="display: block">
        <div  class="incomeCard bg-white tc">
          <p class="font-14">累计总收益（元）</p>
          <span class="font-40 orange"><e:property value="@_formater.formatNumber(sumIncome)"/></span>
          </div>
         </blockquote>
         <blockquote id="scbIncome" style="display: none">
         <div  class="incomeCard bg-white tc">
          <p class="font-14">活期理财累计收益（元）</p>
          <span class="font-40 orange"><e:property value="@_formater.formatNumber(sumAmountScb)"/></span>
        </div>
          </blockquote>
          <blockquote id="fixedIncome" style="display: none">
         <div class="incomeCard bg-white tc">
          <p class="font-14">定期理财累计收益（元）<i class="icon icon-questionmark flip"></i></p>
          <span class="font-40 orange"><e:property value="@_formater.formatNumber(sumIncomeTrust)"/></span>
         ...
         <div class="incomeCard bg-white tc">
          <p class="font-14">基金理财累计收益（元）<i class="icon icon-questionmark flip"></i></p>
          <span class="font-40 orange"><e:property value="@_formater.formatNumber(fundSumIncome)"/></span>
          <div class="panel pa" style="display: none">
                            <span class="profitTip tc pr">
                                <i class="icon-arrow triangle-top"></i>
