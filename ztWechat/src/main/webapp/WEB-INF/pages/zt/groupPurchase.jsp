...
<head lang="en">
    ...
    <script type="text/javascript" src="static/js/zt/purchase.js?v=<%=sysVersion %>"></script>
    <title>组合购买</title>
</head>
<body>
<input type="hidden" id="token" value="<e:property value="@token"/>">
    ...
    <div class="main">
        <div class="redemptionMain redemptionMain-page bg-white">
            <div class="groupTitle">
                <p class="name">策略名称：<e:property value="@policyName"/></p>
                <p class="particulars">策略详情</p>
            </div>
				<table width="100%"
            ...
            <ul class="input-area">
                ...
                <li class="input-wrap-error">
                    ...
                    <span class="amount-text inp-text fl">
                        <input  onblur="calculateProportion()" class="" id="purchase" type="number" name="" placeholder="起购金额<e:property value="@minBuy"/>元"/>
                    </span>
            ...
            <ul class="input-area">
                <li class="forgetPassword pb">
                    ...
                    <div class="checkedBox fl font-text-note light-gray">
                        ...
                        我已阅读并同意遵守<a href="javascript:(void)" class="orange">《懒猫金服基金网上交易协议》</a>
                    </div>
                    <div class="clearfix"></div>
                </li>
            </ul>
...
<input type="button" value="确认购买" class="btnBuy" id="button"/>
...
<div id="alertLayer" class="bg-white" style="display: none; width: 90%; min-height: 33%;">
    <div class="withdrawIntro withdrawText">
        <div>
            <p>为了保证您现有资产的股债平衡</p>
            <p>股票型基金：债券型基金=<e:property value="@proportionResult"/></p>
            <p>正在为您重新调整各基金占比</p>
        </div>
        <div class="elastic">
