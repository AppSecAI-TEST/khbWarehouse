   ...
   <div id="box" class="scb">
    ...
    <e:iterator list="@assetOrderList" var="item">
	    <div class="myInvest bg-white radius1">
	        <a href="zt/asset/toPolicyInvestDetail?policyOrderId=<e:property value="@item.policyOrderId"/>"><h3 class="investTitle br-bottom"><e:property value="@item.sceneName"/>· <e:property value="@item.policyName"/>投资计划 <i class="icon icon-arrow-right fr"></i></h3>
	        </a>
	        <a href="zt/asset/toPolicyInvestDetail?policyOrderId=<e:property value="@item.policyOrderId"/>">
		        <div class="investCon">
	        ...
	        <a href="zt/asset/toPolicyInvestDetail?policyOrderId=<e:property value="@item.policyOrderId"/>">
		        ...
		        <e:if test='@item.totalPurchasing==0'>
		            <e:if test="@item.totalRedeeming==0">
			            <e:if test='@item.currentMonthAmount <= 0.03 '>
	        ...
	        <div class="btns"><a class="btn-small fr" href="zt/groupPurchase/toPurchase?policyOrderId=<e:property value="@item.policyOrderId"/>">追加购买</a><a class="btnUncard orange fr" href="zt/redeem/toRedeem?policyOrderId=<e:property value="@item.policyOrderId"/>">赎回</a></div>
	    </div>
    </e:iterator>
</div>
</body>
