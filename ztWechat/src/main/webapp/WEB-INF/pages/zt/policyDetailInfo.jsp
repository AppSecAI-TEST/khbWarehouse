...
<input type="hidden" value="<e:property value="@ztPolicyCalculateRecordDto.minYieldRate"/>" id="minYieldRate" />
<input type="hidden" value="<e:property value="@ztMemberRetreatRecordDto.recordRate"/>" id="recordRate" />
...
<div class="detailArea" style="position: initial;">
    <div class="rubList bg-white pr">
        <div class="rubText pa">
            <p>为了实现您的愿望</p>
            <p>您需投入：<span class="orange"><e:property value="@_formater.formateMoney(ztPolicyCalculateRecordDto.perInvestAmount)"/></span> 元/月</p>
            <p>连续投资：<span class="orange"><e:property value="@ztPolicyCalculateRecordDto.totalInvestTerm"/></span> 年</p>
            <p>预期市值：<span class="orange"><e:property value="@_formater.formateMoney(ztPolicyCalculateRecordDto.futureAmountMin.intValue())"/>~<e:property value="@_formater.formateMoney(ztPolicyCalculateRecordDto.futureAmountMax.intValue())"/></span> 元</p>
            <p><a href="zt/policy/toQuestion" class="btn-small-w btn-small-orange">常见问题</a> </p>
        </div>
        <img class="repeatImg fr" src='zt/introduce/scenePicture?id=<e:property value="@sceneId"/>' alt=""/>
    </div>
    ...
    <div class="detailContent briefContent">
        ...
        <div class="briefText briefText-new">
            ...
            <p class="tr more"><a href="zt/policy/toCostMore?policyId=<e:property value="@ztPolicyDto.id"/>&type=costDesc">查看更多</a></p>
        </div>
    </div>
    <div class="detailContent briefContent">
    ...
    <div class="h1-2"></div>
    <div class="redemptionBtn btnBot btnBot-new"><input type="button" value="立即购买" class="btnBuy"/></div>
 
<!--弹出层-->
<div id="mask"></div>
<div id="alertLayer" class="bg-white" style="display: none; width: 90%; min-height: 20%;">
    <div class="withdrawIntro detailIntro">
        <div class="text pb15">此策略超过您风险承受能力，是否继续购买？</div>
        <div class="btnArea btnArea-new tc">
            <a href="javascript:void(0)" class="btnClosed singleBtn singleBtn-new fl">取消</a>
            <a href="zt/groupPurchase/toPurchase?sceneId=<e:property value="@sceneId"/>&policyId=<e:property value="@ztPolicyDto.id"/>&purAmount=<e:property value="@ztPolicyCalculateRecordDto.perInvestAmount"/>" class="singleBtn fl">继续购买</a>
        </div>
    </div>
</div>
</body>
