...
$(document).ready(function() {
	...
	$("#dataExportBtn").click(function() {
		if(confirm('是否确定下载文件?')){
		  window.location.href=GV.ctxPath+"ztPolicy/exportNewTransactionOrderList?" + $("#queryNewTransactionOrderListForm").serialize();
		}
	});
	
	$("#sumBtn").click(function() {
		$("#sum_span").html("统计中……");
	    $.post(GV.ctxPath+"ztPolicy/queryNewTransactionOrderTotal", $("#queryNewTransactionOrderListForm").serialize(), 
	        function(result) {
