	...
	<div class="Container">
		<div class="Content fontText">
			<div class="information">
			    ...
			    <form name="updateActivityForm" id="updateActivityForm" action="updateActivity" method="post" enctype="multipart/form-data">
			      <div class="input_cont">
			        <ul>
                      ...
                      <li>
                       ...
                       <option value=1 ${activityInfoDto.isShow==1?'selected':''}>是</option>
                       <option value=0 ${activityInfoDto.isShow==0?'selected':''}>否</option>
                      ...
                      <li>
                        <label class="text_tit">修改活动图片：</label>
