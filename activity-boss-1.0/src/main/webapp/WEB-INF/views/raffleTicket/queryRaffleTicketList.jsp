...
//     });
   ...
   *跳转至新增抽奖券页面
   */
  function addRaffleTicket() {
	  var action = "raffle/toAddRaffleTicket";
	...
	<div class="Container">
		<div class="Content fontText">
			...
			<div class="information">
				<form id="queryRaffleTicketListForm" method="get"
					action="${ctxPath}raffle/queryRaffleTicketList">
					<div class="search">
						<div class="search_tit">
							<h2 class="fw fleft f14">抽奖券查询</h2>
						</div>
...
<!-- 								</li> -->
			...
			<div class="result">
				...
				<q:table queryService="activityQueryService" queryKey="queryRaffleTicketList"
					template="querytableForUnion" formId="queryRaffleTicketListForm"
