        ...
        <!-- <div class="col-md-7">
                ...
                <ul class="timeline">
                        ...
                        <li class="timeline-inverted">
                                ...
                                <div class="timeline-badge info">2016</div>
                            
                            <div class="timeline-panel grid-block">
                                <div class="timeline-heading">
                                    
                                        <h4 class="timeline-title">中航信移动科技有限公司 </h4>
                                    ...
                                    <p>
                                        <small class="text-muted">
                                                ...
                                                <i class="fa fa-calendar"></i> (2016.4 - 2016-5) |
                                            
                                            
                                                <i class="fa fa-map-marker"></i>  中国，北京
                        ...
                        <li class="timeline-inverted">
                            ...
                            <div class="timeline-panel grid-block">
                                <div class="timeline-heading">
                                        ...
                                        <h4 class="timeline-title">TCL集团工业研究院 </h4>
                                    ...
                                    <p>
                                        <small class="text-muted">
                                                ...
                                                <i class="fa fa-calendar"></i> (2015.7 - 2015.9) |
                                            
                                            
                                                <i class="fa fa-map-marker"></i>  中国，深圳
        ...
        <div class="col-md-5">
                ...
                <div class="grid-block">
                    <ul class="list-unstyled list-skills">
                            ...
                            <li>
                                    ...
                                    <span class="caption-skill">Python</span>
                ...
                <div class="grid-block">
                    <ul class="list-unstyled list-strip">
                                    ...
                                    <li>
                                        <i class="fa fa-check"></i> <span class="badge badge-green badge-right-float">Native</span>中文
                                    </li>
                                    ...
                                    <li>
                                        <i class="fa fa-check"></i> <span class="badge badge-green badge-right-float">Limit</span>English
                                    </li>
            ...
            <div class="deviter"></div>
            <h3 class="title with-icon"><span class="fa fa-location-arrow cat-title"></span>Contact Me</h3>
            <div class="grid-block">
                <ul class="social">
                        <li class="weibo"><a href="http://weibo.com/u/1905261931" class="icon48 icon48-8" target="_blank">Weibo</a></li>
                        <li class="renren"><a href="http://www.renren.com/396156731/profile" class="icon48 icon48-10" target="_blank">renren</a></li>
                        <li class="facebook"><a href="https://www.facebook.com/people/%E6%B1%A4%E5%BB%BA%E6%98%8E/100010802836908" class="icon48 icon48-1" target="_blank">Facebook</a></li>
                </ul>
                <ul class="contact">
                        <li>
                            <h4>地址</h4>
