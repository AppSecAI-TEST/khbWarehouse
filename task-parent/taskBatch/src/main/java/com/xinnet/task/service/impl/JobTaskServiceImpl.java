...
import com.xinnet.task.QuartzJobFactory;
import com.xinnet.task.QuartzJobFactoryDisallowConcurrentExecution;
 ...
 * 计划任务管理
 * @author hongbin.kang
 * @date 2017年8月9日下午8:00:27
 */
@Service
@SuppressWarnings({"rawtypes","unchecked"})
public class JobTaskServiceImpl implements JobTaskService {
	public final Logger log = Logger.getLogger(JobTaskServiceImpl.class);
	@Autowired
