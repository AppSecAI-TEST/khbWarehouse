...
import com.xinnet.service.impl.MailServiceImpl;
...
public class SendMailUtil {
	...
	public static void main(String[] args) throws Exception {
		sendEmail("1135758214@qq.com",UUID.randomUUID().toString());
	}
	 ...
	 * @throws Exception
	 */
	public static void sendEmail(String sendAddress,String tittle ,String content)
			throws Exception {
		...
		htmlPart.setContent(
				"<body><div style='width: 1000px;height: 300px;margin: 0px auto;margin-bottom:20px;border:1px solid #92B0DD;background-color: #FFFFFf;'><h3>这是系统自动发送的邮件，请勿回复!有效期15分钟</h3><br/>"+
						content+"</div></body>",
