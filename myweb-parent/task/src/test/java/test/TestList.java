...
public class TestList {  
    ...
    public static void main(String[] args) throws Exception {  
        ...
        map1.put("userId", 1);
        map1.put("username", "cccc");
        map1.put("birthDate", formater.parse("1980-12-01"));
        Map<String, Object> map2 = new HashMap<String, Object>();
        map2.put("userId", 1);
        map2.put("username", "bbbb");
        map2.put("birthDate", formater.parse("1990-12-01"));
        list.add(map1);
        list.add(map2);
        System.out.println("\n-------原来序列-------------------");  
