...
<body>
	<header>
		<%-- <a href="/"><img src="${ctx }/static/img/a.jpg"></a> --%>
	</header>
	<form id="submit">
		<section>
			<h2 class="title-js">注册</h2>
			<div class="email-js">
			...
			<div>
				<button autocomplete="off" class="submit-js">注册</button>
			</div>
			<div class="afterSubmit-js"></div>
		</section>
	</form>
	<footer class="footer-js">您已有注册账户？<a href="${ctx}/account/toLogin?returnUrl=${returnUrl}">请登录</a></footer>
